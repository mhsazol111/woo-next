...
const ProductGridItem = ({ product, index }) => {
  return (
    <Tween from={{ y: 30, delay: 0.7, opacity: 0 }} duration={0.7} delay={0.7 + 0.1 * index} ease="power3.out">
      <div className={`${productStyle.product_item} second_level_blur rounded-md p-5 relative overflow-hidden`}>
